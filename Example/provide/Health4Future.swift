...
let employerAddr = "0x8FE1dEE4C5bb6377DfeE31fD95618e26d6E36eF8"
...
public typealias H4FGenericContractApiSuccessHandler = (AnyObject?) -> Void
...
func getEmployerBalance(employerContractId: String, onSuccess: @escaping H4FNumericContractApiSuccessHandler) {
...
func cashOutEmployer(employerContractId: String, onSuccess: @escaping H4FGenericContractApiSuccessHandler) {
